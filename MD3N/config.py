...
def get_config_regression(model_name, dataset_name, config_file=""):
    ...
    if config_model_name not in config_all and config_model_name == "imder":
        config_model_name = "md3n"
    model_common_args = config_all[config_model_name]['commonParams']
    model_dataset_args = config_all[config_model_name]['datasetParams'][dataset_name]
