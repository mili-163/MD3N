...
from trains.singleTask.model import md3n
...
def MD3N_run(
    ...
    args['pretrained_state_path'] = Path(model_save_dir) / f"pretrained-{args['dataset_name']}.pth"
    args['checkpoint_dir'] = Path(model_save_dir) / "epochs"
    ...
    args['pretrained_state_path'] = Path(args['pretrained_state_path'])
    args['checkpoint_dir'] = Path(args['checkpoint_dir'])
    args['model_save_path'].parent.mkdir(parents=True, exist_ok=True)
    args['pretrained_state_path'].parent.mkdir(parents=True, exist_ok=True)
